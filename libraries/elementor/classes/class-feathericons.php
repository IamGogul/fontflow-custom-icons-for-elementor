...
if( !class_exists( 'FontFlow_WP_Plugin_Elementor_Feather_Icons' ) ) {

	/**
	 * Define the devicons icon library.
	 */
    class FontFlow_WP_Plugin_Elementor_Feather_Icons {
        ...
        public function __construct() {
			...
			do_action( 'fontflow-action/plugin/elementor/icon-library/feathericons/loaded' );
        }
        ...
        public function load( $additional_tabs ) {
            ...
            $additional_tabs[ 'fontflow-feathericons' ] = [
...
if( !function_exists( 'fontflow_wp_plugin_elementor_feather_icons' ) ) {

    /**
     * Returns the instance of a class.
     */
    function fontflow_wp_plugin_elementor_feather_icons() {

        return FontFlow_WP_Plugin_Elementor_Feather_Icons::get_instance();
    }
}

fontflow_wp_plugin_elementor_feather_icons();
